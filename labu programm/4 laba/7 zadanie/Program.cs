...
namespace _7_zadanie
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Итоговое время равно: " + sum + " сек");
            Console.WriteLine("Самая короткая песня - это " + shortestSong);
            Console.WriteLine("Самая длинная песня - это " + longestSong);
            Console.WriteLine("Песни с минимальной разницей в длительности: {0} и {1}", trackList[firstTrackIndex], trackList[secondTrackIndex]);
            Console.ReadKey();
        }
    }
}